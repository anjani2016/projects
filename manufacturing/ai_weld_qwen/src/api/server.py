...
async def inspect_weld(
    ...
    dashscope_api_key: str = Form(None),
    ...
    if dashscope_api_key:
        ...
        os.environ["QWEN_API_KEY"] = dashscope_api_key
    ...
    try:
        ...
        if is_error:
            ...
            agent_output = (
                ...
                f"(Qwen Cloud API is offline or out of credits. Running deterministic local rules engine fallback.)\n\n"
